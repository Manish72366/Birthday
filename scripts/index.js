...
function updateBirthdateYear(distance, currentCountDown) { // you don't have luxury of & here by reference
  // Check if half a day has passed (43200000 milliseconds)
  ...
  // If no update is needed, return the currentCountDown as is
  return currentCountDown;
}
x = setInterval(function() {
  let now = new Date().getTime(),
  distance = countDown - now;
  countDown = updateBirthdateYear(distance , countDown); // if distance mtlb adha din nikl gya bday ko toh agle saal ki date daal do.
  distance = countDown - now; // updating the current distance.
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'BIRTHDAY!', config.name , config.surname],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
